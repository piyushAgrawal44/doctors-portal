...
<body>
    ...
    <div class="container">
        <div class="container__forms">
            <div class="form">
                <!-- Sign In Form  -->
                <form action="../backend/login_signup/doctor_login.php" method="post" onsubmit="return showloader()"
                    class="form__sign-in">
                ...
                <form action="../backend/login_signup/sign_up.php" onsubmit="return showloader()" method="post"
                    ...
                    <div class="form__input-field">
                        ...
                        <input type="tel" minlength="10" placeholder="Business Phone Number" name="phone" required />
                    </div>
                    <div class="form__input-field">
        ...
        <div class="container__panels">
            <div class="panel panel__left">
                <div class="panel__content">
                    ...
                    <h3 class="panel__title" style="color: white;">Welcome to doctors portal !</h3>
                    <p class="panel__paragraph" style="color: white;">
                        For Account activation please contact : <a style="color:wheat; text-decoration:none;" href='mailto:baniyajunction.official@gmail.com'><b>baniyajunction.official@gmail.com</b></a>

                    </p>
                    If you are an admin the
                    <br>

                    <button class="btn" style="background-color: #FF3859; border: 0px; margin-top: 5px;" id="sign-up-btn">
                        Login Here
                    </button>
                </div>
            ...
            <div class="panel panel__right">
                <div class="panel__content">
                    ...
                    <h3 class="panel__title" style="color: white;">Already have an account ?</h3>
                    <p class="panel__paragraph" style="color: white;">
                    Then SIGN IN and get started to doctors portal, where you can manage your business.
                    </p>
