                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center mb-4">
                            <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight"> Patient</h1>
                            </div>
                            <!-- Actions -->
                            <div class="col-sm-6 col-12 text-sm-end">
                                <div class="mx-n1">
                                    
                                    <a href="./new_patient.php" class="btn d-inline-flex btn-sm btn-primary mx-1">
                                        <span class=" pe-2">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <?php
                                                    ...
                                                    $stmt="SELECT count(id) FROM `patient_schema` WHERE status=(?)";
                        ...
                        <div class="col-xl-3 col-sm-6 col-12">
                            <div class="card shadow border-0 overflow_style" style="height: 130px;">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <span class="h6 font-semibold text-muted text-sm d-block mb-2">Blocked Patient</span>
                                            <?php
                            ...
                            <table class="table table-hover table-nowrap" id="myTable"
                                ...
                                <tbody style="border: 0px solid black !important;">
                                    <?php
                                        ...
                                        $stmt="SELECT Patient_schema.id,patient_schema.fullname,patient_schema.email_id,patient_schema.primary_contact_number,patient_schema.status
                                        FROM `patient_schema`";
                                        $sql=mysqli_prepare($conn, $stmt);
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex p-1">
                                            ...
                                            <a class="btn btn-secondary p-2" href="./view_patient.php?id=<?php echo $row['id'];?>">
                                                <span style="font-size: 12px;">View</span>
                                            </a>
                                            
                                            <form action="../../backend/user/update_patient.php"
...
<script>
    document.getElementById("manage_patient").classList.add("active");
</script>
