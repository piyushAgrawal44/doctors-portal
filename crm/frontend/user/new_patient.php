...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow border-0 mb-7 p-sm-5">
                        ...
                        <div class="form-box px-sm-5 mb-5">
                            <form class="px-sm-5" action="../../backend/user/new_patient.php" method="post"
                                onsubmit="return cofirmdetails()" enctype="multipart/form-data">
                                <div class="mb-3">
                                    <label for="doc_name" class="form-label">Patient Name *</label>
                                    <input type="text" placeholder="Patient Name" required class="form-control"
    ...
    <script>
        ...
        function cofirmdetails() {
            var are_you_sure = confirm("Are you sure, you want to send invitation to this Patient ?")
