<?php 
    ...
    if (!isset($_SESSION["is_doctor"])) {
        ...
        $stmt="SELECT fullname,email_id,primary_contact_number,status FROM doctor_schema WHERE id=(?) LIMIT 1";
                    ...
                    <div class="card shadow border-0 mb-7">
                        <div class="card-header">
                            <div class="container-fluid p-sm-5 my-5" style="font-size: 16px;">
                                <form action="../../backend/doctor/updated_details.php" method="post">
                                    <div class="row mb-3">
                                        ...
                                        name="name" value="<?php echo $row["fullname"];?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-auto">
                                        ...
                                        <div class="col">
                                            <input type="email" style="background-color: transparent;outline: none;" name="email" readonly value="<?php echo $row["email_id"];?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-auto ">
                                        ...
                                        <div class="col">
                                            <input type="tel" id="userphone" readonly minlength="10" style="background-color: transparent; outline: none;" name="phone" value="<?php echo $row['primary_contact_number'];?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-auto">
